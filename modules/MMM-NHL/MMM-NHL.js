...
Module.register("MMM-NHL", {
	...
	defaults: {
		...
		includeYesterday: false, // include the previous days results
		colored: true,
		focus_on: false,
		format: "ddd h:mm",
	...
	getDom: function () {
		...
		console.log("yoyoyo", this.scores);
		...
		if (!this.scores) {
			...
			header.innerHTML = "NHL SEASON " + this.season[this.scores[1].games[0].season];
