...
module.exports = NodeHelper.create({
	...
	socketNotificationReceived: function (notification, payload) {
		if (notification === "CONFIG") {
			...
			//build URL
			url =
				"https://statsapi.web.nhl.com/api/v1/schedule?teamId=&gameType=PR,R,P&startDate=" +
				(config.includeYesterday ? yesterday : today) +
				"&endDate=" +
				future +
				"&expand=schedule.team,schedule.linescore,schedule.brodcasts,schedule.metadata";
